...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229CDB7DE0C");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4216052CA");
        ...
        {
            entity.HasKey(e => e.ChangeId).HasName("PK__product___F4EFE596BB5C02CC");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9CD3EFC220");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E616499189BD3").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D31702845A");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C4CE422A9");
